...
const torneios = [
  { id: "t1", name: "Brasileirão SUB-20", federationText: "CBF", federacaoId: "cbf", federacaoSigla: "CBF", category: "SUB-20", year: 2026 },
  { id: "t2", name: "Copa Paulista SUB-17", federationText: "FPF", federacaoId: "fpf", federacaoSigla: "FPF", category: "SUB-17", year: 2026 },
];
